...
import { Shield, Users, FileCheck, Globe, Lock, Eye } from 'lucide-react';
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 space-y-8">
                    <section>
                        ...
                        <p className="text-gray-600">
                            The General Data Protection Regulation (GDPR) is a comprehensive data protection law in the European Union that gives individuals greater control over their personal data. PDF Tools is committed to full GDPR compliance.
                        </p>
                    </section>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 text-sm">Know what data we collect and how we use it.</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                <div className="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <section>
                        ...
                        <div className="text-gray-600 space-y-3">
                            <ul className="list-disc list-inside space-y-2 ml-4">
                                <li>Files are processed locally in your browser - no server storage</li>
                                <li>Minimal data collection with clear purposes</li>
                                <li>Transparent privacy policy and consent mechanisms</li>
                    ...
                    <section>
                        ...
                        <p className="text-gray-600">
                            ...
                            <a href="mailto:dpo@pdftools.com" className="text-purple-600 hover:underline">dpo@pdftools.com</a>. We will respond within 30 days.
                        </p>
                    </section>
                </div>
            </div>
