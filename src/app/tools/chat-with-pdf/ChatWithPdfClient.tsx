...
interface ChatWithPdfClientProps {
...
const ChatWithPdfClient = ({ seoContent, title, subtitle, steps }: ChatWithPdfClientProps) => {
    ...
    return (
        <ToolPageLayout
            ...
            subtitle={subtitle || "Interact with your documents using AI. Ask questions and extract information instantly."}
...
export default ChatWithPdfClient;
