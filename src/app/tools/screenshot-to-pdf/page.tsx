...
import { Loader2, FileText, Plus, Monitor } from 'lucide-react';
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            for (const file of files) {
                ...
                // Screenshots usually look better if we match the image size exactly?
                // Or typically A4 landscape/portrait? Let's use image size for screenshot fidelity.
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <p className="text-center text-gray-500 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
                Turn your screenshots into a single, shareable PDF file.
            </p>
            ...
            {files.length > 0 && (
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                    <h3 className="font-semibold mb-4 text-gray-900 dark:text-white">Selected Screenshots ({files.length})</h3>
