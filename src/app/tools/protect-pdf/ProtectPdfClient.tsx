...
interface ProtectPdfClientProps {
    seoContent: React.ReactNode;
}

const ProtectPdfClient = ({ seoContent }: ProtectPdfClientProps) => {
    ...
    return (
        <ToolPageLayout
            title="Protect PDF Online – Encrypt & Secure PDF Free"
            subtitle="Encrypt your PDF with a password to restrict access. Secure, free, and runs locally in your browser."
            steps={steps}
            ctaText="Protect PDF"
