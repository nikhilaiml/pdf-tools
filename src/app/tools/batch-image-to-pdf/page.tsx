        ...
        try {
            ...
            for (const file of files) {
                ...
                if (file.type === 'image/jpeg') {
                    ...
                    // Fallback for other formats if possible or skip
                    continue;
                }
    ...
    return (
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <p className="text-center text-gray-500 dark:text-gray-400 mb-8 max-w-2xl mx-auto">
                Combine multiple images into a single PDF document. Supports JPG and PNG.
            </p>

            {/* Custom File Uploader for Multiple Files */}
            <div
            ...
            {files.length > 0 && (
                <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 mb-6">
                        ...
                        <div
                            onClick={() => document.getElementById('multi-file-upload')?.click()}
                            className="flex items-center justify-center aspect-square border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 cursor-pointer"
                        >
                    ...
                    >
                        ...
                        <span>{isProcessing ? 'Creating PDF...' : 'Convert to PDF'}</span>
                    </button>
                </div>
            )}
        </div>
