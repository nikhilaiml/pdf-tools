...
import { Loader2, Eraser, FileText, Cloud } from 'lucide-react';
import ToolPageLayout from '../../components/ToolPageLayout';

const RemoveMetadataClient = () => {
    ...
    const steps = [
        {
            ...
            description: "Select or drag and drop your PDF file to remove hidden metadata."
        },
        {
            title: "Step 2: Clean",
            description: "We'll strip all metadata including author, creator, title, and timestamps."
        },
        {
            title: "Step 3: Download",
            description: "Get your clean PDF with all metadata removed for enhanced privacy."
        }
    ];
    ...
    return (
        <ToolPageLayout
            ...
            subtitle="Strip hidden metadata (author, creator, keywords) from your PDF for privacy."
            steps={steps}
            ctaText="Remove Metadata"
        ...
        >
            {!file ? (
                ...
                <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-8">
                    ...
                    >
                        {loading ? <Loader2 className="animate-spin" size={20} /> : <Eraser size={20} />}
                        <span className="text-sm sm:text-base">{loading ? 'Cleaning...' : 'Remove Metadata'}</span>
                    </button>
...
export default RemoveMetadataClient;
